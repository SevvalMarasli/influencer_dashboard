  ...
  return (
    <div className="w-full flex justify-center p-2">
      <header className="w-full max-w-full sm:max-w-5xl bg-white rounded-xl shadow-xl flex justify-between items-center px-3 py-2 sm:px-4 sm:py-4 gap-6">
        ...
        {/* Logo */}
        <h1 className="text-2xl sm:text-3xl font-extrabold tracking-wider font-poppins 
        ...
        {/* Profil */}
        <div className="flex items-center gap-2 sm:gap-3 cursor-pointer p-2 rounded-full hover:bg-gray-100 transition font-lato tracking-wide">
